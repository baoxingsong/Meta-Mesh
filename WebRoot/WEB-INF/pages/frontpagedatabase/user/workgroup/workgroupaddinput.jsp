            ...
            <div id="wrap-content">
                <div id="wrapper-3">
                    <div id="main-wrapper">
                        ...
                        <h4>Add new Work Group.</h4>
                        <s:form action="addWorkGroup" method="post" validate="true">
                       		<s:textfield name="name" label="Name of new Work Group"/>
                       		<tr><td align="center"><input type="submit" id="download_zip" style="width:160px;" value="Add new Work Group" /></td><td align="center"><input type="reset"  id="download_zip" value="Reset" /></td></tr>
						</s:form>
