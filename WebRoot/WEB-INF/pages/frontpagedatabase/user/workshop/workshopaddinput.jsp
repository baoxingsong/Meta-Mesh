        ...
        <div id="wrapper-2">
            <div id="wrap-content">
                <div id="wrapper-3">
                    <div id="main-wrapper">						
                        <div id="main">
                        <h4>Add new Work Shop.</h4>
                        <s:form action="addWorkShop" method="post" validate="true">
                       		<s:textfield name="name" label="Name of new Work Shop"/>
                       		<tr><td align="center"><input type="submit" id="download_zip" style="width:160px;" value="Add new Work Shop" /></td><td align="center"><input type="reset"  id="download_zip" value="Reset" /></td></tr>
						</s:form>
