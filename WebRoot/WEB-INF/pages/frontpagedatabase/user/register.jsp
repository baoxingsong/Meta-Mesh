...
<s:form action="register" method="post" namespace="/user" validate="true">
         <s:textfield name="username" label="Username" />
         <s:password name="password1" label="Create a password"/>
         <s:password name="password2" label="Confirm your password"/>
   ...
   <tr>
     <div id="download-builder">
      <td align="center"><input type="submit" id="download_zip" value="Register"></td>
