...
<span style="color:#f00;weight:folder">Hello, <s:property value="#session.unactivedusername"/>! Please login your mailbox <s:property value="#session.unactivedmailbox"/> to active your Meta-Mesh account.
</span>
