...
Job submit successfully, and we are doing it, you can go to the <h3><a href="getWorkShop?id=<s:property value="metaStormsResult.parallelMetaResult.uploadFile.uploadProject.workShop.id"/>">workshop</a></h3> to view it!
