...
<table width="100%">
<tr><td><s:text name="news_list_page_title"/></td><td><s:text name="inputtime"/></td></tr>
  	<s:iterator value="documents" status="st">
    	<tr <s:if test="#st.odd">style="background-color:#eeeeee"</s:if>>
    	<td><a href="document_content?id=<s:property value="id"/>"><s:property value="title"/></a></td>
    	<td><s:property value="%{getText('global.date',{createTime})}"/></td>
    	</tr>
    </s:iterator>
    	<tr style="background-color:#aaaaaa">
    	<td><a href="file/file/documents_latest.pdf">Download the latest document as PDF.</a></td>
    	<td></td>
    	</tr>
