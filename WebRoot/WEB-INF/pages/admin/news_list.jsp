...
<table width="100%">
  	<s:iterator value="newss" status="st">
    	...
    	<td><a href="news_content?id=<s:property value="id"/>"><s:property value="title"/></a></td>
    	<td><a href="admin/news_delete?id=<s:property value="id"/>">delete</a></td>
    	<td><a href="admin/news_updateinput?id=<s:property value="id"/>">update</a></td>
    	</tr>
    </s:iterator>
</table>
<br/>
