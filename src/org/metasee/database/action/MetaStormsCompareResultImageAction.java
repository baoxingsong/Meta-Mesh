...
public class MetaStormsCompareResultImageAction extends SuperClass {
	private int id;
	...
	{	
		...
		String inputFilePath = GlobalConstant.uploadDir + metaStormsCompareResult.getWorkShop().getOwner().getUserName() + File.separator + GlobalConstant.METASTORMSCOMPARE + File.separator + id + File.separator + "metastormscompare.png";
